  ...
  return (
    <>
      <div className="mx-auto mb-14 max-w-3xl">
        <div className="flex items-center rounded-2xl border border-zinc-700 bg-zinc-900 px-5 focus-within:border-red-600">
      ...
      <div className="mb-8 flex items-center justify-between">
        ...
        <span className="rounded-xl bg-zinc-900 px-4 py-2 text-zinc-400">
